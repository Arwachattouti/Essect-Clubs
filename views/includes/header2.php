        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="listeclubs.php?id=<?php echo $id; ?>" class="nav-item nav-link active" style="color:black;">Home</a>
                        ...
                        if (!empty($clubs)) {
                                foreach ($clubs as $club) {
                                    // Générer un lien dynamique pour chaque club
                        ...
                        <a href="joinclub.php?id=<?php echo $id; ?>" class="nav-item nav-link " style="color:black;">Join Club </a>
                        <a href="suivi_demande.php?id=<?php echo $id; ?>" class="nav-item nav-link " style="color:black;">Suivi Demande </a>
                        <a href="profile.php?id=<?php echo $id; ?>" class="nav-item nav-link " style="color:black;">Profile </a>
