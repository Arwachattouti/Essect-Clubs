        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 wow fadeInLeft mt-md-5" data-wow-delay="0.2s">
                    <img src="/clubs/public/img/join1.gif" alt="Image animée" class="img-fluid">
                </div>
                <div class="col-md-8 text-center text-md-start pb-5 pb-md-0 wow fadeInRight" data-wow-delay="0.1s" style="max-width: 700px;">
                    <p class="fs-5 fw-medium text-primary">Rejoignez-nous</p>
                    <h1 class="display-6 mb-2" style="font-size: 30px;">Devenez membre des clubs étudiants de l'ESSECT</h1>
                    <p class="text-justify">Nous accueillons tous les étudiants intéressés par la technologie, l'innovation et l'envie de faire la différence. En rejoignant un club, vous aurez l'opportunité de développer vos compétences, d'élargir votre réseau et de collaborer avec des personnes passionnées.</p>
                    <a class="btn btn-lg btn-primary mt-1" href="joinclub.php">Rejoindre maintenant</a>
                </div>
            </div>
        </div>
</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <a href="joinclub.php" class="btn btn-link">Rejoindre un club</a>
                        <a href="suivi_demande.php" class="btn btn-link">Suivi de demande</a>
                        <a href="profile.php" class="btn btn-link">Profil</a>
