            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="listeclubs.php" class="nav-item nav-link active" style="color:black;">Accueil</a>
                        ...
                        <a href="login.php" class="nav-item nav-link" style="color:black;">Connexion</a>
                        <a href="register.php" class="nav-item nav-link" style="color:black;">Inscription</a>
                    </div>
