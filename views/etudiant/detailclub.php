...
$clubid=isset($_GET['idclub'])? (int)$_GET['idclub'] : 1;
$controller = new ClubController();
$club = $controller->afficherClubById($clubid); 
require_once __DIR__ . '/../../controllers/DepartementController.php';
$departementController = new DepartementController();
$departements = $departementController->getDepartementsByClubId($clubid);
?>
...
<body>
    ...
    if (class_exists('BureauController')) {
        ...
        $bureau = $controller3->getBureauMembersByClubId($clubid);
    } else {
    ...
    if (class_exists('EventController')) {
        ...
        $events = $controller2->affichereventbyid($clubid);
    } else {
