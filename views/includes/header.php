    ...
    <div class="container-fluid bg-white sticky-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="listeclubs.php" class="navbar-brand d-lg-none">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="listeclubs.php" class="nav-item nav-link active" style="color:black;">Home</a>
                        ...
                        <?php
                            if (!empty($clubs)) {
                                foreach ($clubs as $club) {
                                    ...
                                    echo '<a href="detailclub.php?id=' . $club['id'] . '" class="dropdown-item">' . $club['nom'] . '</a>';
                                }
                            } else {
                        ...
                        <a href="login.php" class="nav-item nav-link " style="color:black;">login </a>
                        <a href="register.php" class="nav-item nav-link" style="color:black;">Register</a>
                    </div>
